...
which allows you to query the NPI Registry and returns up to 1,200 full
NPI records as a data frame (tibble). Next, you can use
[`npi_summarize`](https://docs.ropensci.org/npi/reference/npi_summarize.md)
on these results to obtain a human-readable summary of each record.
Finally,
[`npi_flatten`](https://docs.ropensci.org/npi/reference/npi_flatten.md)
extracts and flattens conceptually-related subsets of data into a tibble
that are joined by the \`npi\` column into an analysis-ready object.
